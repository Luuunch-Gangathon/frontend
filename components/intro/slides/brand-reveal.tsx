    ...
    <div className="relative w-full h-full flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        <div className="text-[clamp(4rem,10vw,9rem)] font-bold tracking-tight text-white leading-none">
          ...
          <span className="inline-block anim-rise anim-rise-delay-2 text-white/80">cast</span>
        </div>

        <p className="text-[clamp(0.85rem,1.6vw,1.15rem)] text-white/65 tracking-[0.35em] uppercase anim-rise anim-rise-delay-4">
          Supply Chain Co-Pilot
        </p>
      </div>

      <p
        className="absolute bottom-20 text-sm text-white/55"
        style={{
          animation:
